...
from environment.pytorch_env import make_vec_env, make_cart_pole_vec_env
...
def learn(actor_critic, agent, args, envs, device):
    ...
    for update in range(num_updates):
        ...
        log_info(writer, update, num_updates, episode_rewards, actor_critic, value_losses, action_losses, entropies, args)
...
def log_info(writer,
    ...
    if (update % args.log_interval == 0) and len(episode_rewards) == 2 * args.log_interval:
